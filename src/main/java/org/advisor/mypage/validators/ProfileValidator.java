package org.advisor.mypage.validators;

import org.advisor.global.validators.PasswordValidator;
import org.advisor.member.libs.MemberUtil;
import org.advisor.mypage.controllers.RequestProfile;
...
public class ProfileValidator implements Validator, PasswordValidator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        if (StringUtils.hasText(mode) && mode.equals("admin") && !StringUtils.hasText(id)) {
            errors.rejectValue("id", "NotBlank");
        }
