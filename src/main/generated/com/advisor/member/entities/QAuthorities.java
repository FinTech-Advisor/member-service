...
public class QAuthorities extends EntityPathBase<Authorities> {
    ...
    private static final long serialVersionUID = -1056014323L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QAuthorities authorities = new QAuthorities("authorities");

    public final EnumPath<com.advisor.member.constants.Authority> authority = createEnum("authority", com.advisor.member.constants.Authority.class);
